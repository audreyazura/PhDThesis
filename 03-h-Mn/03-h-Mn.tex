...
\chapter{Coherent dynamics of Mn-doped positively charged quantum dots}
	...
	Mn atom in II-VI has been studied since more than a decade and is now a well known system~\cite{FirstMn}. Most of the studies was done on the exciton-Mn, since it is the first excited state of the quantum dot. However, the other excited states behave differently due to the presence of other carrier than the single exciton.
