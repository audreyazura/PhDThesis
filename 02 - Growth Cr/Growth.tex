...
%	The growth took place at Tsukuba University, in the team of Pr. Shinji Kuroda. The samples were grown with Molecular Beam Epitaxy (MBE) and Atomic Layer Epitaxy (ALE, for the QD layer), via individual Cd, Te, Zn, Mg and Cr cells. MBE and ALE are two complementary techniques for the growth of semiconductor device.
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=10cm]{MBEScheme.eps}
	\end{center}
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=14cm]{SFDRheed.eps}
	\end{center}
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=14cm]{MBEFull.eps}
	\end{center}
...
Since the growth speed depend on the flux of the cell, we used this method to control it: we first calibrate the growth speed in function of the pressure in the chamber, and then used these equivalence to control the growth process.
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=14cm]{RHEEDStep.eps}
	\end{center}
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=14cm]{RecipeSK.eps}
	\end{center}
...
%		
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=14cm]{HybridSubstrate.eps}
	\end{center}
	...
	For the growth of the quantum well, we had to take into account that the maximum cumulated thickness of CdMgTe grown over CdTe is 130 nm. Above this, the lattice mismatch create dislocation in the barriers \cite{LucienSFD}. We chose to grow 40 nm below the QW, and 90 nm above it, in order to have a thicker protective layer.
...
The recipe is described in Fig.\ref{RecipeSFD}.
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=14cm]{RecipeSFD.eps}
	\end{center}
