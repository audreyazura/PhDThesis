...
\hline\hline	  
	...
	We in the section \ref{QDParam} that each emission can be double for a QD with a a non-null in-plane anisotropy, each of these peaks having dependency in linear polarization. Some dots present this structure, but their evolution in magnetic field didn't show any anti-crossing. Such a dot is presented in Fig.~\ref{CrSixPeaksMagOpt}.
	...
	One common feature of all of these dot is the well defined X$^+$-Cr and X$^-$-Cr emission, visible at
