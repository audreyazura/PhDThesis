...
\chapter{Dynamics and optical control of an individual Cr spin in a CdTe QD\label{CrDyn}}
	...
	\section{Probing the spin fluctuations of the Cr}
...
%	
	...
	\label{ContProbe}
	{\begin{center}
		\includegraphics[width=10.3cm]{Pictures/ContProbe.eps}
	\end{center}}
	\end{figure}
	...
	Going back to alternance of pump and probe pulses, we studied evolution of the quantum dot PL under variation of the probe laser power. The results are presented on Fig.~\ref{PWProbe}. The first noticeable evolution is the increase of the PL intensity during the probe pulse, proportional to the increase of the probe power. A higher power lead to a higher probability of injecting an exciton in the QD. Therefore, more photon will be emitted by the dot, proportionally to the laser power, as long as there is no contribution of the biexciton.
...
\end{figure}
	...
	\begin{center}
		\includegraphics[width=13cm]{Pictures/Pump0.png}
	\end{center}
	\end{figure}
