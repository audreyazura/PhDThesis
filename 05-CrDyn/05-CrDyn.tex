...
\chapter{Optical control of an individual Cr spin in a CdTe QD}
	...
	\end{center}
	\caption{PL transients measured under variation of the probe power: (a) $P_{probe} = 125 $ $\mu$W. (b) $P_{probe} = 250 $ $\mu$W. (c) $P_{probe} = 500 $ $\mu$W. The pump was either off (dark line) or tuned in resonance with the (..) line at $P_{pump} = $ $\mu$W. [TODO: Add power values and line number.]}
	\label{PWProbe}
	\end{figure}	
	...
	\begin{figure}
	\fcapside{\caption{PL transient measured with the resonant pump pulse for a power $P_{probe} = $ $\mu$W. The exponential fit is drawn as a green line and gives a characteristic time of $\tau_{pump} = 60$ ns. The inset presents the evolution of $\tau_{pump}$ in function of the pumping laser power. [TODO: Reduce inset, add the $\tau_{pump}$ value.]}\label{PWPump}}
