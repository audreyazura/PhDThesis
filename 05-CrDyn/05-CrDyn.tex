...
\end{figure}
	...
	\begin{figure}[h!]
	{\caption{(a) Pumping experiment at T= 5 K in circular polarization exciting on the high energy line and detecting either on the low energy line (red) or on one of the line associated with the state $S_z = 0$ (black). (b) Pumping experiemnt at T= 5 K in linear polarization, detecting on one of the line associated with the state $S_z = 0$. The inset presents the experiment configuration, with the excitation shown as a green arrow and the detection as red and black arrows.}\label{Pump0}}	
	\begin{center}
