...
%	\end{figure}
	...
	The evolution under magnetic field of the relative intensity of each of the QD peak gives information on the thermalisation of the QD and thus on the level structure of the X-Cr complex. The temperature bath of QD1 was too high and therefore the relative intensity of each peak didn't seem to vary under magnetic field. The intensity variation is more visible on QD3, in Fig.~\ref{CrMagOptLowSym}, but QD4 presents the clearer evolution in Fig.~\ref{CrAntiferro}. One can see that the low energy line disappear for a high magnetic field under $\sigma-$ excitation, while the high energy line disappear in the same circumstances for a $\sigma+$ excitation.
	...
	A $\sigma-$ excitation inject an exciton with a total angular momentum $X=-1$, and thus a hole $J_z = -\frac{3}{2}$ and an electron $\sigma_z = +\frac{1}{2}$. 
	...
	Phasellus suscipit sapien vel mi eleifend feugiat. Integer non lorem eget metus convallis condimentum. Donec quis est at quam consequat feugiat. Sed finibus interdum dui eu molestie. Quisque vestibulum erat metus, sit amet euismod lectus ultrices nec. Morbi et lorem dui. Vestibulum imperdiet luctus nunc pretium varius. In laoreet nunc vel aliquet consectetur. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent fermentum, lectus nec aliquam efficitur, turpis nibh pretium dolor, et convallis nisi enim et elit. Mauris convallis dignissim velit eget vulputate. Curabitur ex enim, congue ac tellus vel, pretium finibus nulla. 
		
	\section{Modelization of a Cr-doped QD\label{QDParam}}
		
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=10cm]{Pictures/SimuAntiferro.png}
	\end{center}
...
\hline
$-\frac{\pi}{2}$ & 3.0 & 2 & -1 & 0.4 & 1.5 & 25 & 25 \\
\hline\hline
	\end{tabular}
	\label{CrModelParam}
	\end{table}
	
	[The magnetic anisotropy $D_0$ cannot be precisely extracted from the PL spectra. However, a higher value would produce a smaller PL intensity of the sates $S_z=|\pm1\rangle$ than observed experimentally. In addition, for $D_0$ $<$ 2.25 meV, an anti-crossing due to an electron-Cr flip-flop controlled by I$_{eCr}$, labelled (5) in Fig.~\ref{CrMagOptMod}(c), would appear below B$_z$=11T on the central line in $\sigma$+ polarization. TO BE REDISCUSSED TAKING WITH THE POSSIBILITY TO MAKE ANTICROSSING SMALL FOR IeCr CLOSE TO 0]
