...
%	\end{sidewaysfigure}
	...
	\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=15cm]{Pictures/FullPLEv2.eps}
	\end{center}
	\caption{A REFAIRE (a) PLE scan of the lower energy peak, taken close to the QD emission energy, showing the phonon replica taken in $\pi$ detection. The emission integrated intensity in function of the laser energy is plotted in (b) (black curve) along with the PL spectra of QD2 taken in $\sigma_{co}$ polarization.}
	\label{FullPLE}
	\end{figure}
